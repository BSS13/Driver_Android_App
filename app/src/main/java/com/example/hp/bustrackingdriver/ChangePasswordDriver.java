...
public class ChangePasswordDriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et1.setText(GlobalData.driverphone+"");
    ...
    class myjob implements Runnable {
        ...
        public void run() {
            try {
                ...
                URL url = new URL(GlobalData.host + "/change_driver_password_from_app?phonenumber=" + p + "&oldpassword=" + op + "&newpassword="+np+"");
                ...
                if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (datareceived.trim().equals("SUCCESS")) {
                                ...
                                Toast.makeText(ChangePasswordDriver.this, "Password Changed Successfull", Toast.LENGTH_LONG).show();

                            }

                            if (datareceived.trim().equals("FAILURE")){
                                Toast.makeText(ChangePasswordDriver.this, "Wrong Password Entered", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(ChangePasswordDriver.this, "404 NOT Found", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(ChangePasswordDriver.this, "Some ERROR Occoured", Toast.LENGTH_SHORT).show();
                }
